...
- The following group names are reserved by %PAPRECA and **cannot** be used in the LAMMPS input file: del_atoms, delete_atoms, deletion, new_mol, fluid, fluid_temp, frozen, nve_limited, nve_limited_temp, displaced.
- The following fix names are reserved by %PAPRECA and **cannot** be used in the LAMMPS input file: nve_limited_integrator.
- The following variable names are reserved by %PAPRECA and **cannot** be used in the LAMMPS input file: atoms_zmax.
